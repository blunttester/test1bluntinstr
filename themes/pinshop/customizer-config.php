...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_product_acc' => $themify_customizer->accordion_start( __( 'Product', 'themify' ) ),
		...
		'product_summary_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label' => __( 'Product Summary', 'themify' ),
			),
			'selector' => '.post-nav a',
			'prop' => 'font',
		),

		'product_summary_background' => array(
			'control' => array(
				'type'  => 'Themify_Background_Control',
			),
		...
		// Archive Product Title ul.products li.product h3

		'product_title_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Archive Product Title', 'themify' ),
			),
		...
		'product_title_hover_font' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Text_Decoration_Control',
				'label'   => __( 'Archive Product Title Hover', 'themify' ),
			),
			'selector' => 'ul.products li.product h3:hover',
			'prop' => 'font',
		),

		'product_title_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
		...
		'product_title_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'color_label' => __( 'Background Color', 'themify' ),
		...
		'product_title_hover_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'product_title_hover_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'product_title_hover_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		// Single Product Title .single-product .product .product_title

		'product_title_single_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Single Product Title', 'themify' ),
			),
			'selector' => '.single-product .product .product_title',
			'prop' => 'font',
		),

		'product_title_single_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.single-product .product .product_title',
		...
		'product_title_single_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'color_label' => __( 'Background Color', 'themify' ),
			),
		...
		'product_title_single_border' => array(
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
			'selector' => '.single-product .product .product_title',
		...
		'product_title_single_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => '.single-product .product .product_title',
		...
		'product_title_single_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => '.single-product .product .product_title',
		...
		'product_title_single_hover_font' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Text_Decoration_Control',
				'label'   => __( 'Single Product Title Hover', 'themify' ),
			),
			'selector' => '.single-product .product .product_title:hover',
			'prop' => 'font',
		),

		'product_title_single_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
		...
		'product_title_single_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'color_label' => __( 'Background Color', 'themify' ),
		...
		'product_title_single_hover_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'product_title_single_hover_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'product_title_single_hover_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		// Archive Product Price ul.products li.product .price

		'product_price_single_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Archive Product Price', 'themify' ),
			),
			'selector' => 'ul.products li.product .price',
			'prop' => 'font',
		),

		'product_price_single_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => 'ul.products li.product .price',
		...
		'product_price_single_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'color_label' => __( 'Background Color', 'themify' ),
			),
		...
		'product_price_single_border' => array(
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
			'selector' => 'ul.products li.product .price',
		...
		'product_price_single_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => 'ul.products li.product .price',
		...
		'product_price_single_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => 'ul.products li.product .price',
		...
		// Single Product Price .single-product .product .price

		'product_price_single_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Single Product Price', 'themify' ),
			),
			'selector' => '.single-product .product .price',
			'prop' => 'font',
		),
		...
		// Product Sale Tag .onsale

		'product_sale_tag_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Product Sale Tag', 'themify' ),
			),
			'selector' => '.onsale',
			'prop' => 'font',
		),

		'product_sale_tag_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.onsale',
		...
		'product_sale_tag_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
		...
		'product_sale_tag_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		'product_sale_tag_hover_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Product Sale Tag Hover', 'themify' ),
			),
			'selector' => '.onsale:hover',
			'prop' => 'font',
		),

		'product_sale_tag_hover_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.onsale:hover',
		...
		'product_sale_tag_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
		...
		'product_sale_tag_hover_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'product_sale_tag_hover_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'product_sale_tag_hover_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		// Archive Add To Cart Button ul.products li.product .add_to_cart_button

		'add_to_cart_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Archive Add To Cart Button', 'themify' ),
			),
			'selector' => 'ul.products li.product .add_to_cart_button',
			'prop' => 'font',
		),
		...
		'add_to_cart_hover_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Archive Add To Cart Button Hover', 'themify' ),
			),
			'selector' => 'ul.products li.product .add_to_cart_button:hover',
			'prop' => 'font',
		),

		'add_to_cart_hover_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => 'ul.products li.product .add_to_cart_button:hover',
		...
		'add_to_cart_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
		...
		'add_to_cart_hover_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'add_to_cart_hover_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'add_to_cart_hover_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		// Single Add To Cart Button .single-product .product .single_add_to_cart_button

		'add_to_cart_single_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Single Add To Cart Button', 'themify' ),
			),
			'selector' => '.single-product .product .single_add_to_cart_button',
			'prop' => 'font',
		),

		'add_to_cart_single_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.single-product .product .single_add_to_cart_button',
		...
		'add_to_cart_single_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
		...
		'add_to_cart_single_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'add_to_cart_single_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'add_to_cart_single_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		'add_to_cart_single_hover_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Single Add To Cart Button Hover', 'themify' ),
			),
			'selector' => '.single-product .product .single_add_to_cart_button:hover',
			'prop' => 'font',
		),

		'add_to_cart_single_hover_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.single-product .product .single_add_to_cart_button:hover',
		...
		'add_to_cart_single_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
		...
		'add_to_cart_single_hover_border' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Border_Control',
			),
		...
		'add_to_cart_single_hover_margin' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
		...
		'add_to_cart_single_hover_padding' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
		...
		'end_product_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
