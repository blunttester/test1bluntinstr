...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Fixed Header', 'themify'),
			'function' => 'fixed_header_module'
		),
		array(
...
$themify_theme_config['panel']['settings']['tab']['shop_settings'] = array(
	...
	'custom-module' => array(
		array(
			'title' => __('Shop Page Settings', 'themify'),
		...
		array(
			'title' => __( 'Product Archive Layout', 'themify' ),
			'function' => 'shop_archive_layout'
		),
		array(
			'title' => __('Product Slider', 'themify'),
			'function' => 'product_slider'
		),
		array(
			'title' => __('Search Field Option', 'themify'),
			'function' => 'shop_search_field_option'
		)
	)
);
