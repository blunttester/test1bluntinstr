...
<div class="wrap">
	...
	<h2><?php _e( 'Product Slider and Carousel with Category for WooCommerce - Features', 'woo-product-slider-and-carousel-with-category' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Product Slider and Carousel with Category for WooCommerce</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tbody>
			...
			<tr>
				<th>Show Product Ratings <span>Display products rating</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
			...
			<tr>
				<th>Post Order / Order By Parameters <span>Display product according to date, title and etc</span></th>
				<td><i class="dashicons dashicons-yes"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Child Category <span>Option to display child category or not</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
	    	<tr>
