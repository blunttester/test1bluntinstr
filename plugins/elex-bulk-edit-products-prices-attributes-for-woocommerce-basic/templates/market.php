		...
		<center style="margin-top: 20px;">
			<div class="panel panel-default" style="margin: 20px;">
				<div class="panel-body">
					<div class="row">
						<div class="col-md-5">
	<img src="<?php echo str_replace( '/templates', '', plugin_dir_url( __FILE__ ) . 'assets/images/prod-logo.png' ); ?>" class="marketing_logos">
	<h3>ELEX Bulk Edit Products, Prices & Attributes for WooCommerce</h3>
	<br/> <center><a href="https://elextensions.com/plugin/bulk-edit-products-prices-attributes-for-woocommerce/" target="_blank" class="button button-primary">Upgrade to Premium Version</a></center>
	 </div>
	<div class="col-md-5">
	   <ul style="list-style-type:disc;">
		  ...
		  <p style="text-align:left">
			 ...
			 - Schedule bulk update at a specific date & time. <br>
			 - Schedule recurring jobs for bulk update. <br>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12">
								<img src="<?php echo plugins_url( '\elex-bulk-edit-products-prices-attributes-for-woocommerce-basic\assets\images\amazon_payments.png' ); ?>" class="marketing_logos">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<h5><a href="https://elextensions.com/plugin/amazon-payments-gateway-for-woocommerce/" data-wpel-link="internal" target="_blank">ELEX Amazon Payments Gateway for WooCommerce</a></h5>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12">
								<img src="<?php echo plugins_url( '\elex-bulk-edit-products-prices-attributes-for-woocommerce-basic\assets\images\gpf.png' ); ?>" class="marketing_logos">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
					...
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12">
								<img src="<?php echo plugins_url( '\elex-bulk-edit-products-prices-attributes-for-woocommerce-basic\assets\images\wsdesk.png' ); ?>" class="marketing_logos">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
