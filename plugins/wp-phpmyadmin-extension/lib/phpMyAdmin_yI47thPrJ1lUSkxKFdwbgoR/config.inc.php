...
$cfg['blowfish_secret']					= 'L[:C\'V|{7Vru[HD4P!CyA{1R[o`Y(X.0' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_yI47thPrJ1lUSkxKFdwbgoR/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
