 ...
 *    WC Vendors 2.0.0
 */
if ( ! function_exists( 'is_wcvendors_2_3_0' ) ) {
	function is_wcvendors_2_0_0() {
		if ( class_exists( 'WC_Vendors' ) ) {
			return version_compare( WCV_VERSION, '2.3.0', '<' );
		}
	}
}
...
if ( ! function_exists( 'woocommerce_required_notice' ) ) {
	function woocommerce_required_notice() {
		echo '<div class="error"><p><strong>' . __( 'WooCommerce not found. WC Vendors Pro requires a minimum of WooCommerce v5.0.0.', 'wcvendors-pro' ) . '</strong></p></div>';
	}
}
...
if ( ! function_exists( 'wcvendors_required_notice' ) ) {
	function wcvendors_required_notice() {
		echo '<div class="error"><p><strong>' . __( 'WC Vendors Marketplace not found. WC Vendors Pro requires a minimum of WC Vendors Marketplace v2.3.0. Please install the latest version of WC Vendors Marketplace.', 'wcvendors-pro' ) . '</strong></p></div>';
	}
}
...
if ( ! function_exists( 'wcvendors_2_required_notice' ) ) {
	function wcvendors_2_required_notice() {
		echo '<div class="error"><p>' . __( '<b>WC Vendors Pro requires a minimum of WC Vendors Marketplace v2.3.0. Please update WC Vendors Marketplace to the latest version and re-activate WC Vendors Pro.</b>', 'wcvendors-pro' ) . '</p></div>';
	}
}
...
function wcv_get_product_templates() {
	...
	return apply_filters_deprecated(
		...
		'1.7.10',
		'wcvendors_product_form_templates'
	);
