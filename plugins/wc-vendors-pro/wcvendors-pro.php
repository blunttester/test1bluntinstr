...
if ( is_woocommerce_active() ) {
	...
	if ( is_wcvendors_active() ) {
		...
		function wcslc_instance() {
			return WC_Software_License_Client::get_instance( 'https://wcvendors.com/', 'https://wcvendors.com/product/wc-vendors-pro', WCV_PRO_VERSION, 'wc-vendors-pro', __FILE__, 'WC Vendors Pro', 'wc-vendors-pro' );
		} // wcslc_instance()
