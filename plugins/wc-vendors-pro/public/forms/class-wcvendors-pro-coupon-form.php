...
class WCVendors_Pro_Coupon_Form {
	...
	public static function coupon_code( $coupon_code ) {
		...
		if ( isset( $_POST['wcv_save_coupon'] ) ) {
			$coupon_code = array_key_exists( '_wcv_coupon_post_title', $_POST ) ? $_POST['_wcv_coupon_post_title'] : '';
		}
		...
		WCVendors_Pro_Form_Helper::input(
			apply_filters(
				...
				array(
					...
					'data_type'         => 'percent' === $discount_type ? 'decimal' : 'price',
	...
	public static function expiry_date( $expiry_date ) {
		...
		if ( isset( $_POST['wcv_save_coupon'] ) ) {
			$expiry_date = array_key_exists( '_wcv_coupon_post_meta_expiry_date', $_POST ) ? $_POST['_wcv_coupon_post_meta_expiry_date'] : '';
		}
