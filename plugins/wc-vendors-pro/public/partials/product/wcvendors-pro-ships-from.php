...
if ( isset( $ships_from['wrapper_start'] ) && $ships_from['wrapper_start'] != '' ) {
	echo $ships_from['wrapper_start'];
}

echo '<span>' . $ships_from['title'] . ' ' . $ships_from['store_country'] . '</span>';

if ( isset( $ships_from['wrapper_end'] ) && $ships_from['wrapper_end'] != '' ) {
	echo $ships_from['wrapper_end'];
}
