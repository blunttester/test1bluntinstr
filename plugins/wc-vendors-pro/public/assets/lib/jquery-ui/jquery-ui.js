...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, droppable.js, resizable.js, selectable.js, sortable.js, button.js, datepicker.js, dialog.js, menu.js, progressbar.js, tabs.js, tooltip.js
...
$.ui.plugin.add(
	...
	"connectToSortable",
	{
		start: function( event, ui, draggable ) {
			...
			draggable.sortables = [];
			$( draggable.options.connectToSortable ).each(
			function() {
	...
	_doKeyDown: function(event) {
			...
			if ($.datepicker._datepickerShowing) {
				switch (event.keyCode) {
					...
					case 33: $.datepicker._adjustDate(
						event.target,
						(event.ctrlKey ?
...
var dialog = $.widget(
	...
	_moveToTop: function( event, silent ) {
			var moved = false,
			zIndices  = this.uiDialog.siblings( ".ui-front:visible" ).map(
				function() {
...
var tabs = $.widget(
	...
	_setupHeightStyle: function( heightStyle ) {
			...
			if ( heightStyle === "fill" ) {
				...
				this.element.siblings( ":visible" ).each(
				function() {
				var elem     = $( this ),
					position = elem.css( "position" );
