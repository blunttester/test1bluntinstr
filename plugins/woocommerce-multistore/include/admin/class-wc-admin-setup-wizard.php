 ...
 * Setup Wizard Class
 *
 * Takes new users through some basic steps to setup their WooMultistore.
 *
 * @author      Tonny
 * @category    Admin
...
class WC_Admin_Setup_Wizard {
	...
	public function __construct() {
		if ( apply_filters( 'woocommerce_enable_setup_wizard', true ) && current_user_can( 'manage_woocommerce' ) ) {
			...
			add_action( 'user_admin_menu', array( $this, 'admin_menus' ) );
	...
	public function wc_setup_introduction() {
		?>
        <form method="post">
		<h1><?php _e( 'Welcome to WooMultistore!', 'woonet' ); ?></h1>
		<p><?php _e( 'Thank you for choosing WooMultistore to power your online WooCommerce store! This quick setup wizard will make sure that all of your multisite stores are ready for use with this plugin.', 'woonet' ); ?></p>
	...
	public function wc_setup_network_sites() 
        {
		    ...
		    <form method="post">
			    ...
			    <p><?php _e( 'Once updated, the data become available to be used with WooMultistore plugin.', 'woonet' ); ?></p>
	...
	public function wc_setup_ready() {
		...
		<h1><?php _e( 'Your site is Ready for use with WooMultistore!', 'woonet' ); ?></h1>
		...
		<div class="wc-setup-next-steps">
			...
			<div class="wc-setup-next-steps-last">
				...
				<ul>
					<li class="learn-more"><a target="_blank" href="https://woomultistore.com/documentation/"><?php _e( 'Read more about getting started', 'woonet' ); ?></a></li>
				</ul>
			</div>
		</div>
		<?php
