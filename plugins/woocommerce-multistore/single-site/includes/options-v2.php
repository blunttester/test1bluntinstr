			...
			<div class="wrap">
				...
				<form id="form_data" name="form" method="post">
					...
					<table class="form-table">
						...
						<tr valign="top">
							<th scope="row">
								<select name="__options[master][use-global-image]">
									<option value="no" <?php selected( 'no', $options['master']['result']['use-global-image'] ); ?>><?php esc_html_e( 'No', 'woonet' ); ?></option>
									<option value="yes" <?php selected( 'yes', $options['master']['result']['use-global-image'] ); ?>><?php esc_html_e( 'Yes', 'woonet' ); ?></option>
								</select>
							</th>
							<td>
								<label><?php esc_html_e( 'Use global image', 'woonet' ); ?>
									<span class='tips'
										data-tip='<?php esc_html_e( 'If enabled, parent images will not be copied to the child site. They will be linked from the parent site.', 'woonet' ); ?>'>
									<span class="dashicons dashicons-info"></span></span></label>
							</td>
						</tr>
						...
						<tr valign="top">
							<th scope="row">
								<select name="__options[master][sync-by-sku]">
									<option value="no" <?php selected( 'no', $options['master']['result']['sync-by-sku'] ); ?>><?php esc_html_e( 'No', 'woonet' ); ?></option>
									<option value="yes" <?php selected( 'yes', $options['master']['result']['sync-by-sku'] ); ?>><?php esc_html_e( 'Yes', 'woonet' ); ?></option>
								</select>
							</th>
							<td>
								<label><?php esc_html_e( 'Sync by SKU', 'woonet' ); ?>
									<span class='tips'
										data-tip='<?php esc_html_e( 'If enabled, existing products and variations on the child sites will be matched by the SKU.', 'woonet' ); ?>'>
									<span class="dashicons dashicons-info"></span></span></label>
							</td>
						</tr>
						</tbody>
